 ...
 * It also stores Prerequisites
 * It has all methods of the CollegeClass interface
 * It has all methods of the AdvancedCollegeClass interface 
 * It has one more method as the writer of this class seemed to need it called 
